...
export const portfolioProfile = {
  ...
  legalDocumentationNotice:
    'بيانات التوثيق الأساسية المعتمدة لملف نُطق التعريفي، وتستخدم لتوضيح الهوية التجارية عند التواصل أو طلب نطاق عمل.',
  englishLegalDocumentationNotice:
    'Verified business identification details for Notaq profile, used to clarify the commercial identity during contact or scope requests.',
  legalDocumentation: [
    {
      label: 'السجل التجاري',
...
export const projects: PortfolioProject[] = [
  ...
  buildProject({
    ...
    liveUrl: 'https://ريق.com/',
    coverImage: screenshotOf('https://ريق.com/', 'desktop'),
    screenshots: [
      screenshotOf('https://ريق.com/', 'desktop'),
      screenshotOf('https://ريق.com/', 'tablet'),
      screenshotOf('https://ريق.com/', 'mobile'),
    ],
    thumbnailImage: screenshotOf('https://ريق.com/', 'tablet'),
