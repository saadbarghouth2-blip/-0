...
const TeamMemberCard = ({ member, isArabic }: { member: typeof teamMembers[0]; isArabic: boolean }) => {
  ...
  return (
    <div className="perspective-1000 h-[285px] w-full relative sm:h-[360px]">
      <motion.div
      ...
      >
        ...
        <div className="absolute inset-0 backface-hidden w-full h-full rounded-[1.15rem] border border-white/10 bg-[#06090f]/75 p-4 flex flex-col justify-between shadow-xl sm:rounded-3xl sm:p-6">
          <div className="flex justify-between items-start">
            ...
            <div className={cn(
              "w-12 h-12 rounded-2xl bg-gradient-to-br flex items-center justify-center font-black text-lg text-white shadow-lg sm:h-14 sm:w-14 sm:text-xl",
              member.color
            )}>
              {member.avatar}
            </div>
            ...
            <button 
              ...
              className="text-[9px] text-cyan-400 font-bold bg-cyan-500/10 border border-cyan-500/20 px-2 py-1 rounded-full flex items-center gap-1 hover:bg-cyan-500/20 sm:px-3 sm:py-1.5 sm:text-[10px]"
            >
          ...
          <div className="space-y-1.5 mt-3 sm:mt-4 sm:space-y-2">
          ...
          {/* Social connections */}
          <div className="border-t border-white/5 pt-3 flex gap-3 text-slate-500 text-xs sm:pt-4">
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/10 px-4 py-2 text-sm font-medium text-cyan-300 mb-6">
            <Users2 className="h-4 w-4 text-cyan-400 md:h-5 md:w-5" />
          ...
          <h1 className="font-display text-4xl md:text-6xl font-bold text-white mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-violet-400">
              {text('وتطور حضور شركتك الرقمي', 'building clearer digital experiences for your company')}
            </span>
          </h1>
          <p className="text-slate-400 text-base md:text-xl max-w-2xl mx-auto">
            {text(
              ...
              'Boutique design and development team focused on making your company experience clearer, faster, and easier to trust.'
            )}
          </p>
        </motion.div>
        ...
        {/* Members Grid layout */}
        <div className="grid gap-3 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3 mb-10 sm:mb-20">
